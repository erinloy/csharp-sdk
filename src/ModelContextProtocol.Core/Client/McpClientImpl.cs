...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    /// <inheritdoc/>
    public override event EventHandler<ConnectionErrorEventArgs>? ConnectionError;
    ...
    public async Task ConnectAsync(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                // Hook into message processing task to detect disconnection
    ...
    public override async ValueTask DisposeAsync()
    {
        ...
        {
            // Fire the Disconnected event if not already fired
    ...
    /// <summary>
    /// Registers a continuation on the message processing task to detect disconnection.
    /// </summary>
    private void RegisterDisconnectionDetection()
    {
        var messageProcessingTask = _sessionHandler.GetType().GetProperty("MessageProcessingTask",
            System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic)?.GetValue(_sessionHandler) as Task;
        ...
        _ = messageProcessingTask.ContinueWith(task =>
        {
            ...
            if (Interlocked.CompareExchange(ref _disconnectedEventFired, 1, 0) == 0)
            {
                ...
                if (!isGraceful)
                {
                    ...
                    if (error != null)
                    {
                        LogTransportDisconnectedUnexpectedly(_endpointName, error);
                    }
                }
    ...
    private void OnConnected(ConnectedEventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            LogEventHandlerError("Connected", _endpointName, ex);
        }
    }
    ...
    private void OnDisconnected(DisconnectedEventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            LogEventHandlerError("Disconnected", _endpointName, ex);
        }
    }
    ...
    private void OnConnectionError(ConnectionErrorEventArgs e)
    {
        ...
        catch (Exception ex)
        {
            ...
            LogEventHandlerError("ConnectionError", _endpointName, ex);
        }
    }
}
